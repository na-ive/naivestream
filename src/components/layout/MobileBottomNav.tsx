...
import { Home, PlayOutline, Search, CheckmarkOutline, Bookmark, Close } from '@carbon/icons-react';
...
export function MobileBottomNav() {
  ...
  return (
    <>
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-[60] bg-background/90 backdrop-blur-lg border-t border-secondary/20 safe-area-pb">
            ...
            return (
              ...
              >
                <div className={cn(
                  ...
                  isActive ? "bg-secondary/10" : "group-active:bg-secondary/10"
                )}>
                  <Icon className={cn("w-6 h-6", isActive && "stroke-[0.5px]")} />
                </div>

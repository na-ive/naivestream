...
export function SearchClient({ initialGenres, initialStudios }: { initialGenres: any[], initialStudios: string[] }) {
  ...
  const studioOptions = (initialStudios || []).map((s: string) => ({ value: s, label: s }));
...
// Remove SearchPage export since it will be in page.tsx
